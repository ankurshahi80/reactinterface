    ...
    <div>
      ...
      </button>
      {
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input type="text" name="ownerName" id="ownerName"
              ...
              className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:max-w-xs sm:text-sm border-gray-300 rounded-md"
            />
          </div>
        </div>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input type="time" name="aptTime" id="aptTime"
              ...
              className="max-w-lg blo
              ck w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:max-w-xs sm:text-sm border-gray-300 rounded-md"
            />
          </div>
        </div>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <textarea name="aptNotes" id="aptNotes" rows="3"
              onChange={(event)=>{setFormData({...formData, aptNotes: event.target.value})}}
              value={formData.aptNotes}
              className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:max-w-xs sm:text-sm border-gray-300 rounded-md" placeholder="Detailed comments about the condition"
            ></textarea>
          </div>
        </div>
